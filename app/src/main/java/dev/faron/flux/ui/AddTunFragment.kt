...
import dev.faron.flux.util.dpToPx
...
class AddTunFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<TextView>(R.id.formTitle).text =
            getString(if (editing == null) R.string.add_tunnel_title else R.string.edit_config)
